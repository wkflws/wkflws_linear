...
async def process_issue_labels(
    ...
    """Process issue_labels events from Linear.

    Args:
        data: The issue_labels event from Linear.
        context: Contextual information about the workflow being executed.
    """
    logger = getLogger("wkflws_linear.issue_labels")
    logger.setLevel(10)
    logger.info("Processing Linear issue_labels event...")
    return data
...
if __name__ == "__main__":
    ...
    output = asyncio.run(process_issue_labels(message, context))
